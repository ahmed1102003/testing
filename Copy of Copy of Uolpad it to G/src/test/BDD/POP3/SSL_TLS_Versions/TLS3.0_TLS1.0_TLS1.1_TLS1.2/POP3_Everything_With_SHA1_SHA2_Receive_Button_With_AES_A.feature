Feature: Daliy
 ...
 Scenario: POP3_TLS1.2_With_SHA1_Receive_Button_With_AES
  ...
  And wait 5 seconds
  And I click on '//*[@id="CTLEncrypt2"]' with '2'
  And I click on '//*[@id="CTLEncrypt3"]' with '3'
  And I click on '//*[@id="CTLHash0"]' with '0'
  And wait 7 seconds
