Feature: Access to POP3 page with Incorrect data setup then on click Receive button with connection Error result
 
 Scenario: Access to POP3 page with Incorrect data setup then on click Receive button with connection Error result
  ...
  And swtich to frame '//*[@id="printingjobs"]'
  And wait 1 seconds
  And I click on '//*[@id="b100px"]' with 'Receive'
