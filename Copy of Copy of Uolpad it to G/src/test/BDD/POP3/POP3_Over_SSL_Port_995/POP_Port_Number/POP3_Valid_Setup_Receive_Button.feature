Feature: Access to POP3 page with correct data setup then on click Receive button with connection ok result
 
 Scenario: Access to POP3 page with correct data setup then on click Receive button with connection ok result
